...
var nombre_formulario_modal1 = "#frmActivarTenant"; //id
...
// Fin de configuraciones
    ...
    $('document').ready(function() {
        $('.activar').on('click',function(e){
            ...
            $('#modal_codigoTenant2').val(Pid);
            $('#modal_name2').text(name);
        });


        $('#frmActivarTenant').submit(function(e) { // catch the form's submit event
                e.preventDefault();
