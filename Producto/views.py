...
class ListarTopping(TemplateView):
    def get(self,request,*args,**kwargs):
        ...
        context = {'toppings': toppings, 'toppingsL': toppingsL , 'black': tinte, 'grid' : sidebar_grid, 'inverse': nav_var_color, 'color' : color, 'font' : font}
...
class ListarProducto(TemplateView):
    def get(self,request,*args,**kwargs):
        ...
        context = {'productos': productos, 'productosL': productosL, 'pro':pro , 'black': tinte, 'grid' : sidebar_grid, 'inverse': nav_var_color, 'color' : color, 'font' : font } 
        return render_to_response(
...
class CrearTopping(TemplateView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        context = {'black': tinte, 'grid' : sidebar_grid, 'inverse': nav_var_color, 'color' : color, 'font' : font  } 
        return render_to_response('crear_topping.html', context,
			context_instance=RequestContext(request))
...
class EditarToppig(TemplateView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        tinte = franquicia.tinte
        font = franquicia.font
        context={'topping':topping, 'black': tinte, 'grid' : sidebar_grid, 'inverse': nav_var_color, 'color' : color, 'font' : font }
...
class EditarProducto(TemplateView):
    def get(self,request,*args,**kwargs):
        ...
        context={'producto':producto, 'toppings':toppings, 'toppings3':toppings3 ,  'black': tinte, 'grid' : sidebar_grid, 'inverse': nav_var_color, 'color' : color, 'font' : font }
